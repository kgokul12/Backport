...
#        return f"commit {short_cmid} not available"
    ...
    deps_result = subprocess.run(f"git log origin/stable_kernel_6.11 --oneline --grep=\"Fixes: {short_cmid}\"", stdout=subprocess.PIPE, shell=True, universal_newlines=True)
